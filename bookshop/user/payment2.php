...
<div class="container text-center mt-5">
    ...
    <form method="POST" action="zalo_payment.php" target="_self">
        ...
        <button type="submit" class="btn btn-primary btn-lg">🟣 Thanh toán qua Zalopay</button>
    </form>
    ...
    <div class="alert alert-info mt-4">
        ⚠️ Bạn sẽ được chuyển hướng đến trang thanh toán Zalopay.
    </div>
</div>
</body>
</html>
