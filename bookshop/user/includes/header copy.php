...
<body style="background-color: #f0fff0">
    ...
    <form class="d-flex align-items-center" style="max-width: 600px;" method="GET" action="products.php">
      <div class="input-group">
        <input type="search" name="keyword" class="form-control border-start-0" placeholder="Tìm kiếm sách..." aria-label="Search">
    ...
    <div class="d-flex align-items-center gap-3 ms-4">
      ...
      <!-- <a href="cart.php" class="text-dark" title="Giỏ hàng"><i class="fa fa-shopping-cart fa-lg"></i></a> -->
      <!--<a href="login.php" class="text-dark" title="Đăng nhập">
